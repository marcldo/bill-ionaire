            ...
            <section className="page-section" id="services">
              <div className="row">
                <div className="col-lg-12 text-center">
                  ...
                  <h3 className="section-subheading text-muted">
                    Finance is an important topic in everyone’s lives,we have decided to develop <br />
                    a tool that will help you maintain finance with amazing services of this app.
                  </h3>
                </div>
              </div>
              <div className="row text-center">
                ...
                <div className="col-md-4">
                  ...
                  <p className="text-muted">
                    This app is Responsive that means you can operate
                    it from any device you are using.
                  </p>
                </div>
              </div>
            </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-muted">This app is created by aour amazing team.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/1.jpg" alt=""></img>
        ...
        <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/2.jpg" alt=""></img>
            <h4>Wajiha Ahmad</h4>
            <p class="text-muted">Developer</p>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/3.jpg" alt=""></img>
            <h4>Poonam Halani</h4>
            <p class="text-muted">Developer</p>
          </div>
        </div>
